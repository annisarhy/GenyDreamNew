...
class RolePermissionSetup extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'geny:rolepermit';
     ...
     * @var string
     */
    protected $description = 'Generate role and permission';
    ...
    {
        $roles = ["Super Admin", "Perusahaan","Pelamar"];
