...
<div class="container">
    ...
    <div class="col-md-7 mx-auto py-5">
        <div class="card box-shadow p-5">
            ...
            <a href="{{ route('pelamar.bank.elektronik') }}" class="btn btn-lg btn-mbanking pl-5 pr-5 mt-5">LANJUTKAN</a>
            <a href="{{ route('pelamar.bank.manual') }}" class="btn btn-lg btn-atm pl-5 pr-5 mt-5">LANJUTKAN</a>
        </div>
    </div>
</div>
@endsection
