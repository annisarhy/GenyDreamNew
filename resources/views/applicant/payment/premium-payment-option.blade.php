...
<div class="header-jumbotron mt-5 text-center pt-5">
    <h1 class="font-weight-bold mt-3">GENY DREAM <span>PREMIUM</span></h1>
</div>
...
<div class="container">
    ...
    <div class="col-md-7 mx-auto py-5">
        <div class="card box-shadow p-5">
            ...
            <div class="menu-list" onclick="window.location='{{ route('pelamar.credit.card') }}'">
                <div class="d-flex">                                
            ...
            <div class="menu-list mt-2" onclick="window.location='{{ route('pelamar.pulsa') }}'">
                <div class="d-flex">                                
                    <div class="col-md-2 menu-list-img mt-2">
                        <img src="{{ asset('images/la_money-bill-solid-blue.png') }}" class="img-fluid img-left-menu" alt="">
                    </div>
            ...
            <div class="menu-list mt-2" onclick="window.location='{{ route('pelamar.emoney') }}'">
                <div class="d-flex">                                
                    <div class="col-md-2 menu-list-img mt-2">
                        <img src="{{ asset('images/la_money-bill-solid-blue.png') }}" class="img-fluid img-left-menu" alt="">
                    </div>
            ...
            <div class="menu-list mt-2" onclick="window.location='{{ route('pelamar.bank.option') }}'">
                <div class="d-flex">                                
                    <div class="col-md-2 menu-list-img mt-2">
                        <img src="{{ asset('images/la_money-bill-solid-blue.png') }}" class="img-fluid img-left-menu" alt="">
                    </div>
