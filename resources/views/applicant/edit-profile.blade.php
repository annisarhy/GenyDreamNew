          ...
          <div class="p-3 py-5">
            <div class="row mt-2">
              <div class="col-md-6"><label class="labels">Nama Depan</label>
                <input name="nama_depan" type="text" class="form-control" placeholder="first name" value="John">
              </div>
              <div class="col-md-6"><label class="labels">Nama Belakang</label>
                <input name="nama_belakang" type="text" class="form-control" value="Doe" placeholder="Doe">
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-md-12">
                <label class="labels">No. KTP</label>
                <input name="no_ktp" type="text" class="form-control" placeholder="headline" value="327304999999">
              </div>
              <div class="col-md-12">
                <label class="labels">Email</label>
                <input type="text" class="form-control" placeholder="headline" value="annamarie@mail">
              </div>
              <div class="col-md-12">
                <label class="labels">Handphone</label>
                <input name="no_hp" type="text" class="form-control" placeholder="headline" value="0821111111">
              </div>
              <div class="col-md-12">
              ...
              <div class="col-md-12">
                <label class="labels">Posisi Sekarang</label>
              ...
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" placeholder="education" value="Boston University">
              </div>
              <div class="col-md-12">
                <label class="labels">Alamat</label>
                <input name="alamat" type="text" class="form-control" placeholder="headline" value="Jl. Cangkuang">
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" value="Bandung" placeholder="state">
              </div>
            </div>
            <div class="mt-5 text-center">
              <button class="btn btn-primary btn-block profile-button" type="submit">Simpan Profile</button>
            </div>
          </div>
        </form>
      </div>
