...
<div class="container">
    <div class="row justify-content-center">
        <div class="d-inline berita-menu text-center mt-1">
            <a href="{{ route('list.berita') }}" class="font-weight-bold active ml-4 mr-4">All</a>
            <a href="{{ route('list.berita.lifestyle') }}" class="font-weight-bold ml-4 mr-4">Lifestyle</a>
            <a href="{{ route('list.berita.tipsKarir') }}" class="font-weight-bold ml-4 mr-4">Tips Karir</a>
            <a href="{{ route('list.berita.keahlian') }}" class="font-weight-bold ml-4 mr-4">Keahlian</a>
            <a href="{{ route('list.berita.tentang.perusahaan') }}" class="font-weight-bold ml-4 mr-4">Tentang Perusahaan</a>
            <a href="{{ route('list.berita.berita.umum') }}" class="font-weight-bold ml-4 mr-4">Berita Umum</a>
        </div>
