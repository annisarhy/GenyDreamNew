...
<div class="container">
    ...
    <div class="row mt-5 pl-3 pr-3 justify-content-between">
        <a href="{{ route('admin.add.perusahaan') }}" class="btn btn-lg pt-3 btn-tambah-perusahaan"><i class="fa fa-plus mr-3"></i>TAMBAH PERUSAHAAN</a>

        <div class="form mt-2">
            <div class="input-group mb-3">
                <input type="text" class="form-control form-search" placeholder="Cari Nama Perusahaan" aria-label="Cari Nama Perusahaan">
            ...
            <div class="card box-shadow-card p-2">                
                <div class="card-body">                    
                    <div class="row justify-content-between">
                        <img src="{{ asset('images/gojek.png') }}" alt="image-perusahaan" class="img-perusahaan-list img-fluid">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('admin.add.perusahaan') }}"><img src="{{ asset('images/mdi_pencil.png') }}" alt=""> EDIT</a>
                    ...
                    <div class="row">
                        <div class="company-info">
                            <p class="company-name font-weight-bold mb-0 mt-4">PT. GOJEK INDONESIA</p>
                            <p class="company-email">gojekindonesia@gmail.com</p>
                        </div>
                    </div>      
                    
                    <div class="row justify-content-end mt-4">
                        <a href="{{ route('admin.detail.perusahaan') }}" class="btn btn-detail">DETAIL</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mt-2">
            <div class="card box-shadow-card p-2">                
                <div class="card-body">                    
                    ...
                    <div class="row justify-content-end mt-4">
                        <a href="{{ route('admin.detail.perusahaan') }}" class="btn btn-detail">DETAIL</a>                    </div>
                </div>
            </div>
        </div>
