    ...
    <div class="d-flex mt-5 mb-5" id="wrapper">
        ...
        <div class=" border-right" id="sidebar-wrapper">            
            <div class="list-group list-group-flush">
                ...
                <a href="{{ route('admin.berita.index') }}" class="list-group-item list-group-item-action"><img src="{{ asset('images/bx_bx-news-gray.png') }}" alt="" class="img-fluid mr-2">KELOLA KONTEN</a>
